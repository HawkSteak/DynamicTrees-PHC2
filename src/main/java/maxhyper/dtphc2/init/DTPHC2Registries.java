...
public class DTPHC2Registries {
    ...
    public static final Item PASSION_FRUIT_VINE_ITEM = new FruitVineItem(PASSION_FRUIT_VINE, new Item.Properties().tab(DTRegistries.ITEM_GROUP));

    public static final FruitVineBlock VANILLA_VINE = new FruitVineBlock().setSeasonOffset(2f); //winter
    public static final Item VANILLA_VINE_ITEM = new FruitVineItem(VANILLA_VINE, new Item.Properties().tab(DTRegistries.ITEM_GROUP));

    public static final FruitVineBlock PEPPERCORN_VINE = new FruitVineBlock().setSeasonOffset(0f); //summer
    public static final Item PEPPERCORN_VINE_ITEM = new FruitVineItem(PEPPERCORN_VINE, new Item.Properties().tab(DTRegistries.ITEM_GROUP));

    public static final Item RIPE_PEPPERCORN_ITEM = new RipePeppercornItem(new Item.Properties().tab(DTRegistries.ITEM_GROUP));
